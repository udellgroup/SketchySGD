...
def main():
    ...
    parser.add_argument('--opt', type = str, required = True, help = "Optimization method: only 'sketchysgd'") # Optimizer
    parser.add_argument('--precond', type = str, required = True, help = "Preconditioner type: one of 'nystrom' or 'ssn' (default is None)")
