...
def get_experiments(data_obj, model_type, model_params, opt, precond_type, hyperparams, auto_lr, max_epochs, bh):
    if opt in ['sgd', 'saga']:
        ...
        # Get the experiments
        experiments = [ExperimentStream(data_obj, model_type, model_params, opt, opt_params) for opt_params in params_list]
        ...
        experiments = [ExperimentStream(data_obj, model_type, model_params, opt, opt_params)]
...
def main():
    ...
    parser.add_argument('--opt', type = str, required = True, help = "Optimization method: one of 'sgd', 'saga', 'sketchysgd'") # Optimizer
    parser.add_argument('--precond', type = str, default = None, help = "Preconditioner type: one of 'nystrom' or 'ssn'") # Preconditioner type
    ...
    experiments = get_experiments(data_obj, problem_type, model_params, opt, precond_type, hyperparams, auto_lr, epochs, bh)
